    ...
    @section('sidebar-menu-left')
        <!-- Left sidebar menu goes here -->
            <ul class="list-group sidebar-list" id="sidebar">
                <li>
                    <a  href="{{url('admin/dashboard')}}" class="active list-group-item sidebar-list-item"><i class="fa fa-home fa-2x"></i> Home</a>
                </li>
                <li>
                    <a  href="{{url('admin/registration-fees')}}" class="list-group-item sidebar-list-item"><i class="fa fa-money fa-2x"></i> Registration Fees</a>
                </li>
                <li>
                    <a  href="{{url('admin/exam-fees')}}" class="list-group-item sidebar-list-item"><i class="fa fa-money fa-2x"></i> Exam Fees</a>
                </li>
            </ul>
    @endsection
