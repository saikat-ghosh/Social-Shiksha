                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div id="post-query" class="row padding">
                            ...
                            <form action="/teacher/discussion-details/{{$details->id}}/update" method="POST">
                                {{ csrf_field() }}
                                <div class="form-group">

                                    <label for="DFD_Details">Edit your query</label>
                                    <div>
                                         <input id="DFD_Details" type="text" class="form-control" name="DFD_Details" placeholder="{{ $details->DFD_Details }}" required>
                                    </div>
                                </div>
                                <div class="form-group">
