    ...
    @section('sidebar-menu-left')
        ...
        <!-- Left Sidebar menu goes here -->
                <ul class="list-group sidebar-list" id="sidebar">
                    ...
                    <li>
                        <a  href="{{url('/teacher/upload-student-marks')}}" class="active list-group-item sidebar-list-item"><i class="fa fa-upload fa-2x"></i> Upload Student Performance Marks</a>
                    </li>
                    <li>
