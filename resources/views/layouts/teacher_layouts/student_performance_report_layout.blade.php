    ...
    @section('sidebar-menu-left')
        ...
        <!-- Left Sidebar menu goes here -->
                <ul class="list-group sidebar-list" id="sidebar">
                    ...
                    <li>
                        <a  href="{{url('/teacher/student-performance-report')}}" class="active list-group-item sidebar-list-item"><i class="fa fa-pencil-square-o fa-2x"></i> Student Performance Details Report</a>
                    </li>
                    <li>
