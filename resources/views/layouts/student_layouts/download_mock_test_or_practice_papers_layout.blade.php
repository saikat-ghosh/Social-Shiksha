    ...
    @section('sidebar-menu-left')
        ...
        <!-- Left Sidebar menu goes here -->
                <ul class="list-group sidebar-list" id="sidebar">
                    ...
                    <li>
                        <a   href="{{url('student/download-test-or-practice-paper')}}" class="active list-group-item sidebar-list-item"><i class="fa fa-download fa-2x"></i> Download Mock Test/Practice Paper</a>
                    </li>
                    <li>
