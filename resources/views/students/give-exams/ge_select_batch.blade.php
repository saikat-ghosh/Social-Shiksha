               ...
               <div class="col-md-8 col-md-offset-2">
                   <div class="panel panel-default">
                       <div class="panel panel-heading">
                           <b>Select Batch for giving Exams</b>
                       </div>
                       ...
                       <div class="panel panel-body">
                           ...
                           @else
                            <form class="form-horizontal padding" action="{{action('StudentController@selectExam')}}" method="post">
                                {{ csrf_field() }}
                               <!-- Search by Batches -->
                               ...
                               <div class="form-group">
                                   <button type="submit" class="btn btn-primary pull-right">Search Exams</button>
                               </div>
                            </form>
                            @endif
                       </div>
