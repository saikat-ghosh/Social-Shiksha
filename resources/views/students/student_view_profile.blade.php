...
@extends('layouts.dashboard-layout')
    ...
    @section('navbar-menu-left')
            ...
            <!-- Left Navbar menu goes here -->
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="{{url('student/view-profile')}}" class="active-menu"><i class="fa fa-user fa-2x"></i> Profile</a>
                    </li>
                    <li>
                        <a  href="{{url('student/batch-details')}}"><i class="fa fa-edit fa-2x"></i> Batches</a>
                    </li>
                    <li>
    ...
    @section('menu-content')
            ...
            <h1 style="font-family: Montserrat, Lato; color: red; text-decoration: none;font-size: 65%; text-shadow: 4px 4px 6px gray;font-style: none;"><u style="list-style: none;text-decoration: none;"><b> Profile</b></u></h1>
    @endsection
