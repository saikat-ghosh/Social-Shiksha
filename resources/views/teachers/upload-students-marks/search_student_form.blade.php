               ...
               <div class="col-md-8 col-md-offset-2">
                   <div class="panel panel-default">
                       <div class="panel panel-heading">
                           <b>Search Student For Marks Upload</b>
                       </div>
                       ...
                       <div class="panel panel-body">
                           ...
                           @else
                            <form class="form-horizontal padding" action="{{ action('TeacherController@getStudentForMarksUpload') }}" method="post">
                                {{ csrf_field() }}
                               <!-- Search by Batches -->
                                <div class="form-group">
                                    <label for="Batch_id" class="control-label">Select Batch First</label>
                                    <div>
                                        <select name="Batch_Id" id="Batch_id" class="form-control input-sm">
