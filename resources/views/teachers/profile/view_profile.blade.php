@extends('layouts.teacher_layouts.profile_layout')
    ...
    @section('menu-content')
            ...
            <!-- Teacher's profile information goes here -->
                        ...
                        <div class="panel-body padding">
                            ...
                            <form class="form-horizontal col-sm-8" role="form" action="{{ action('TeacherController@edit_profile') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input id="name" type="text" class="form-control" name="Inst_Name" value="{{ $teacher->T_Stu_Name }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input id="email" type="text" class="form-control" name="Inst_Email" value="{{ $teacher->T_Stu_Email }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input id="phone" type="text" class="form-control" name="Inst_No" value="{{ $teacher->T_Stu_No }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input id="address" type="text" class="form-control" name="Inst_Addr" value="{{ $teacher->T_Stu_Addr }}" placeholder="Enter Address" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input id="username" type="text" class="form-control" name="Inst_User_Id" value="{{ $teacher->T_Stu_User_Id }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-8 col-md-offset-4">
                                        ...
                                        <a class="btn btn-link" href="{{ action('TeacherController@view_profile') }}">
                                            Cancel
                                        </a>
                                    </div>
                                </div>
