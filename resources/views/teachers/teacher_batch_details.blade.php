                                    ...
                                    <ul class="list-group striped-list">
                                        @foreach($associatedBatches as $id=>$batch)
                                            <li class="list-group-item">
                                                ...
                                                {{ $batch->Batch_Subject }}
                                                <a class="btn btn-info btn-xs pull-right batch-delete" role="button" data-target="#confirm-batch-delete" data-toggle="modal" data-delete-link="{{ action('TeacherController@removeBatch', $id) }}"><span class="glyphicon glyphicon-trash"></span>&nbsp;delete&nbsp;</a>
                                            </li>
                                        @endforeach
                                    </ul>
                                @endif
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <center>
                        ...
                        @else
                            <form  action="{{ action('TeacherController@assignBatch') }}" method="POST">
                                {{ csrf_field() }}
