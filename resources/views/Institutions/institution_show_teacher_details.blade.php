    ...
    @section('navbar-menu-left')
            ...
            <!-- Left Navigation Bar menu -->
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="#" class="active-menu"><i class="fa fa-pencil-square-o fa-2x"></i> Teacher Details</a>
                    </li>
                    <li  >
                        <a   href="{{url('institution/student-details')}}"><i class="fa fa-pencil-square-o fa-2x"></i> Student Details</a>
                    </li>
                    <li>
